...
* Page footer to include: Generated by AI Gatekeeper · Built by Sarah Douglas · github.com/VictoriusSecret · linkedin.com/in/sarahbdouglas/
...
Clears existing report from UI.
...
* Is triggered by a "Try Demo" link on the welcome screen
...
* The PDF should have a page footer on every page that states: Generated by AI Gatekeeper · Built by Sarah Douglas · github.com/VictoriusSecret · linkedin.com/in/sarahbdouglas/
...
The "Download PDF" button appears at the top of the report screen.  Report is structured as a list, not a table.
